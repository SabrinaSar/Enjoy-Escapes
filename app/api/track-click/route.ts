...
//         {
//           success: false,
//           error: "Invalid item_type. Must be 'escape' or 'banner'",
//         },
//         { status: 400 },
//       );
//     }
...
//     const { error } = await supabase.from("clicks_data").insert({
//       escape_id: escape_id,
//       item_type: item_type,
//       source: source || null,
...
export async function POST(request: NextRequest) {
  ...
  const { escape_id, item_type = "escape", source, user_agent, referrer } =
    data;
